...
//  final String _baseUrl = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=';
//
  ...
  Future<String?> generateContent(String prompt) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (response.statusCode == 429 || response.body.contains('quota') || response.body.contains('exceeded')) {
      ...
      print('Error: An exception occurred during the API request: $e');
      rethrow; // حتى تستطيع معالجته خارج الدالة
    }
  }
